    ...
    <div id="content">
        ...
        <section class="shopping-cart padding-bottom-60">
            <div class="container">
                ...
                <!-- Button -->
                <div class="pro-btn"><a href="{{route('products')}}" class="btn-round btn-light">Continue Shopping</a>
                    @if(Cart::count() != 0)
                        <a href="{{route('getdeliverymethod')}}" class="btn-round">Go Delivery Methods</a>
                    @endif
                </div>
            </div>
        </section>
